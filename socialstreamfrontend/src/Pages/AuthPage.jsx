  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        const response = await fetch(`${API_BASE_URL}/public/api/v1/register`, {
          method: 'POST',
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="absolute top-6 right-6 flex items-center gap-2 px-4 py-2 bg-purple-500/20 backdrop-blur-sm rounded-lg border border-purple-500/30 text-purple-300 hover:bg-purple-500/30 hover:text-purple-200 transition-all z-10"
